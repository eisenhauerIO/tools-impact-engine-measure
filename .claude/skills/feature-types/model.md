...
from impact_engine_measure.models.{MODEL_NAME} import {CLASS_NAME}
...
- Use `merge_model_params()` from `impact_engine_measure.models.conftest` for configs needing defaults
