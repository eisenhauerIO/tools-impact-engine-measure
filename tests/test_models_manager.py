...
from impact_engine_measure.models.factory import MODEL_REGISTRY
...
class TestModelsManagerParamFiltering:
    ...
    def test_overrides_subject_to_filtering(self):
        ...
        mock_model.get_fit_params.side_effect = lambda p: {k: v for k, v in p.items() if k == "intervention_date"}
        mock_model.fit.return_value = ModelResult(model_type="mock", data={"test": True})
